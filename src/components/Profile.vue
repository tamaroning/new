<template>
  <el-container>
    <el-main>
      <h2>インターンなど</h2>
      <ul>
        <li><p>2022年3月(3 weeks) エンジニアインターン at Wantedly, Inc.</p></li>
        <li><p>2021年9月~現在 CSE at Coincheck, Inc.</p></li>
        <li><p>2021年8月~9月(1 month) インターン at Coincheck, Inc.</p></li>
      </ul>

      <h2>活動など</h2>
      <ul>
          <li><p>セキュリティキャンプ全国大会2021 脅威解析トラック 修了</p></li>
        <li><p>SecHack365 Trainee 2期生 修了</p></li>
        <li><p>アプリ甲子園2018 総務大臣賞</p></li>
        <li><p>Unityインターハイ2018 ゴールドアワード</p></li>
      </ul>
